...
namespace TestDataTable
{
    public partial class Form3 : Form
    {
        ...
        {
            InitializeComponent();
            this.Text = "Booksmsm' pictures";
            //подключение к БД
            conn = new SqlConnection(connStr);
        }
        ///<summary>
         ///В этом обработчике пользователь может выбрать картинку для загрузки в БД. После выбора картинки вызывается метод LoadPicture() в котором картинка
         ///преобразовывается в байтовый массив и заносится в БД
         ///</summary>
        ...
        ///<summary>
        ///В этом методе создается и выполняется параметризированный запрос insert, который заносит уменьшенную копию выбранной картинки в БД
        ...
        /// <summary>
        /// В этом методе анализируется ориентация картинки и создается копия этой картинки таким образом, чтобы максимальный размер
        ///картинки (высота или ширина) не превышал 300 пикселей. Пропорции картинки при этом не искажаются
        ///</summary>
        ...
        ///<summary>
         ///в этом методе выполняется запрос, выводящий все записи таблицы Pictures
         ///</summary>
         ///<param name="sender"></param>
         ///<param name="e"></param>
        ...
        ///<summary>
        ///в этом методе выполняется запрос, выводящий запись таблицы Pictures по заданному id
        ///</summary>
        ///<param name="sender"></param>
        ///<param name="e"></param>
        private void btnIndex_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                da = new SqlDataAdapter("select picture from Pictures where BookId = @id; ", conn);
                SqlCommandBuilder cmb = new SqlCommandBuilder(da);
